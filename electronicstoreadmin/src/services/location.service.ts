...
export class LocationService {
     ...
     */
    static async createCity(cityData: { name: string; stateId: number }): Promise<ApiResponse<CityResponse>> {
        try {
     ...
     */
    static async createLocality(localityData: { name: string; pincode: string; cityId: number }): Promise<ApiResponse<LocalityResponse>> {
        try {
